...
void botnana_attach_event (struct Botnana * desc,
                           const char * address, uint32_t count,
                           void (* fn)(const char * str));
...
void botnana_set_slave(struct Botnana * desc,
	uint32_t position, const char * tag,
	int32_t value);
...
// set slave config
void botnana_set_slave_config(struct Botnana * desc, uint32_t position,
	const char * tag, int32_t value);

//set motion config
void botnana_set_motion_config(struct Botnana * desc,
	uint32_t perios_us,
...
void botnana_set_group_config_vmax(struct Botnana * desc,
	uint32_t position,
	double vmax);

//set group config amax
void botnana_set_group_config_amax(struct Botnana * desc,
	uint32_t position,
	double amax);

//set group config jmax
void botnana_set_group_config_jmax(struct Botnana * desc,
	uint32_t position,
	double jmax);

void botnana_get_group_config(struct Botnana * desc,
	uint32_t position);
...
void botnana_set_axis_config_encoder_length_unit(struct Botnana * desc,
	uint32_t position,
	const char * unit);

void botnana_set_axis_config_ppu(struct Botnana * desc,
	uint32_t position,
	double ppu);

void botnana_set_axis_config_home_offset(struct Botnana * desc,
	uint32_t position,
	double offset);

void botnana_set_axis_config_encoder_direction(struct Botnana * desc,
	uint32_t position,
	uint32_t direction);

...
#[no_mangle]
pub fn get_slave(botnana: Box<Botnana>, position: libc::uint32_t) {
...
#[no_mangle]
pub fn get_slave_diff(botnana: Box<Botnana>, position: libc::uint32_t) {
...
/// get version
#[no_mangle]
pub fn get_version(botnana: Box<Botnana>) {
...
/// save config
#[no_mangle]
pub fn save_config(botnana: Box<Botnana>) {
